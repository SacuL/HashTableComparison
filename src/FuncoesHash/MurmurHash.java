...
public class MurmurHash implements InterfaceHashing {
    ...
    public int hash(byte[] data, int offset, int len, int seed) {
        ...
        /// Modificação ////
        ////////////////////
//        System.out.println("Resultado  int: " + h1);
//        long UnsignedValor = h1 & 0x00000000ffffffffL;
//        System.out.println("Resultado long: " + UnsignedValor);
//        System.out.println("Resultado uint: " + ((int) UnsignedValor));
        return Math.abs(h1);
    }

...
public class MurmurHash implements InterfaceHashing {
    ...
    public long hashLong(String s) {
        ...
        // Antes simplesmente retornava h1.
        return (long) h1 & 0xffffffffL;

    }
//int unsigned_int = resultado_funcao_hashing;
//long unsigned_int_em_um_long = (long) unsigned_int & 0xffffffffL;
//long long_com_mod = unsigned_int_em_um_long % TAMANHO_TABELA;
//int resultado = (int) long_com_mod;
